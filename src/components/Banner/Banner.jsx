          ...
          <div className="container min-h-[550px] flex justify-center items-center py-12 sm:py-0 ">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 ">
                      ...
                      <div className='flex flex-col justify-center gap-6 sm:pt-0'>
                          <h1
                              data-aos="fade-up"
                              className='text-3xl sm:text-4xl font-bold font-cursive'>Premium Blend Coffee</h1>
                          <p
                              data-aos="fade-up"
                              className='text-sm text-gray-500 tracking-wide leading-5 '>
                              Premium blend has achieved a fine balance by combining the delicate smoothness of Arabica with the heartiness of Robusta. Sublime and compact, this blend has a dash of acidity.
                          </p>
                          ...
                          <div className='grid grid-cols-2 gap-6 '>
                              ...
                              <div
                                  ...
                                  <p className='text-gray-500 text-sm '>{" "}
                                      Much like writing code, brewing the perfect cup of tea requires patience ,precision, and a dash of passion to ccreate a comforting blend of flavors.</p>
                              </div>
                        </div>
